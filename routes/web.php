...
Route::prefix('payment')->name('payment.')->middleware(['installed'])->group(function () {
    ...
    Route::get('/table/{order}/pay', [PaymentController::class, 'tablePayment'])->name('tablePayment');

    Route::get('/{paymentGateway:slug}/{order}/pay', [PaymentController::class, 'index'])->name('index');
