...
use App\Http\Controllers\Admin\CopyItemController;
...
use App\Http\Controllers\Frontend\DeliverySetupController as FrontendDeliverySetupController;
use App\Http\Controllers\Table\ItemController as TableItemController;

use App\Http\Controllers\Webhook\BranchController as WebhookBranchController;
...
Route::prefix('admin')->name('admin.')->middleware(['installed', 'apiKey', 'auth:sanctum', 'localization'])->group(function () {
    ...
    Route::prefix('setting')->name('setting.')->group(function () {
        ...
        Route::prefix('branch')->name('branch.')->group(function () {
            ...
            Route::prefix('delivery-setup')->name('delivery-setup.')->group(function () {
                Route::get('/{branch}', [DeliverySetupController::class, 'index']);
                Route::post('/{branch}', [DeliverySetupController::class, 'store']);
                Route::match(['put', 'patch'], '/{branch}/{deliverySetup}', [DeliverySetupController::class, 'update']);
                Route::delete('/{branch}/{deliverySetup}', [DeliverySetupController::class, 'destroy']);
            });

            Route::prefix('time-slot')->name('time-slot.')->group(function () {
                Route::get('/{branch}', [TimeSlotController::class, 'index']);
                Route::post('/{branch}', [TimeSlotController::class, 'store']);
                Route::delete('/{branch}/{timeSlot}', [TimeSlotController::class, 'destroy']);
            });
        });
        ...
        Route::prefix('rider-tip')->name('rider-tip.')->group(function () {
            ...
            Route::match(['put', 'patch'], '/update/{riderTip}', [RiderTipController::class, 'update']);
    ...
    Route::prefix('coupon')->name('coupon.')->group(function () {
        ...
        Route::get('/download-attachment', [CouponController::class, 'downloadAttachment']);
        Route::post('/import/file', [CouponController::class, 'import']);
    });
    ...
    Route::prefix('item')->name('item.')->group(function () {
        ...
        // copy item
        Route::get('/copy-list', [CopyItemController::class, 'index']);
        Route::post('/copy/items', [CopyItemController::class, 'copyItems']);
    });
...
Route::prefix('frontend')->name('frontend.')->middleware(['installed', 'apiKey', 'localization'])->group(function () {
    ...
    Route::prefix('address')->name('address.')->middleware(['auth:sanctum'])->group(function () {
        ...
        Route::post('/delivery-address', [FrontendAddressController::class, 'deliveryAddressStore']);
    ...
    Route::prefix('offer')->name('offer.')->group(function () {
        ...
        Route::get('/show/{slug}/{branch}', [FrontendOfferController::class, 'offerItems']);
    ...
    Route::prefix('item-category')->name('item-category.')->group(function () {
        ...
        Route::get('/show/{itemCategory:slug}/{branch}', [FrontendItemCategoryController::class, 'show']);
    });
    ...
    Route::prefix('time-slot')->name('time-slot.')->group(function () {
        Route::get('/today/{branch}', [FrontendTimeSlotController::class, 'todayTimeSlot']);
        Route::get('/tomorrow/{branch}', [FrontendTimeSlotController::class, 'tomorrowTimeSlot']);
    });
    ...
    Route::prefix('delivery-setup')->name('delivery-setup.')->group(function () {
        Route::get('/{branch}', [FrontendDeliverySetupController::class, 'index']);
        Route::get('/distance-check/{branch}', [FrontendDeliverySetupController::class, 'distanceCheck']);
    });
});

// webhook  
Route::prefix('webhook')->name('webhook.')->middleware(['installed', 'apiKey', 'localization'])->group(function () { 
    Route::prefix('branch')->name('branch.')->group(function () {
        Route::get('/', [WebhookBranchController::class, 'index']);
        Route::get('/show/{branch}', [WebhookBranchController::class, 'show']);
        Route::get('/orders/{branch}', [WebhookBranchController::class, 'orders']);
    });

    Route::get('/orders', [WebhookController::class, 'orders']);
    Route::post('/order/change-status/{order_serial_no}', [WebhookController::class, 'changeStatus']);
...
Route::prefix('table')->name('table.')->middleware(['installed', 'apiKey', 'localization'])->group(function () {
    ...
    Route::prefix('item')->name('item.')->group(function () {
        Route::get('/{table_slug}', [TableItemController::class, 'index']);
    });
