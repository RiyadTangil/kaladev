...
export const item = {
    ...
    actions: {
        ...
        copyLists: function (context, payload) {
            return new Promise((resolve, reject) => {
                let url = 'admin/item/copy-list';
                if (payload) {
                    url = url + appService.requestHandler(payload);
                }
                axios.get(url).then((res) => {
        ...
        copyItems : function(context, payload){
            return new Promise((resolve, reject) => {
            let method = axios.post;
            let url = '/admin/item/copy/items';
        ...
        resetItemList: function(context){
            context.commit('resetItemList');
        }
    },
    mutations: {
