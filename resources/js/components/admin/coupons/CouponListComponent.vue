            ...
            <div class="db-card-header border-none">
                ...
                <div class="db-card-filter">
                    ...
                    <div class="dropdown-group">
                        <ImportComponent />
                        <div class="dropdown-list db-card-filter-dropdown-list">
                            <button @click="download" class="db-card-filter-dropdown-menu">
                                <i class="lab lab-sample-file lab-font-size-17"></i>
                                {{ $t('button.sample_file') }}
                            </button>
                            <button type="button" @click="fileUploadModal" data-modal="#modal"
                                class="db-card-filter-dropdown-menu">
                                <i class="lab lab-upload-file lab-font-size-17"></i>
...
import ImportComponent from "../components/buttons/export/ImportComponent.vue";
...
import CouponFileUploadComponent from "./CouponFileUploadComponent.vue";
...
export default {
    ...
    methods: {
        ...
        download: function () {
            this.loading.isActive = true;
            this.$store.dispatch("coupon/download").then((res) => {
                this.loading.isActive = false;
                ...
                link.href = url;
                link.download =
                    "" + this.$t("menu.coupons") + "ImportSample." + 'xlsx';
                link.click();
                URL.revokeObjectURL(link.href);
            }).catch((err) => {
                this.loading.isActive = false;
