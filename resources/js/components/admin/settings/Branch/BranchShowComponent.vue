<template>
    ...
    <div class="col-12">
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 mb-5">
            <button type="button" data-tab="#information"
            ...
            <button type="button" data-tab="#map"
            ...
            <button type="button" data-tab="#deliverySetup"
                class="profile-tabBtn w-full flex items-center gap-3 h-10 px-4 rounded-lg transition bg-white hover:text-primary hover:bg-primary/5">
                <i class="lab lab-delivery-setup"></i>
                <span class="capitalize text-sm">{{ $t("menu.delivery_setup") }}</span>
            </button>
            <button type="button" data-tab="#timeSlot"
                class="profile-tabBtn w-full flex items-center gap-3 h-10 px-4 rounded-lg transition bg-white hover:text-primary hover:bg-primary/5">
                <i class="lab lab-time-slots"></i>
                <span class="capitalize text-sm">{{ $t("menu.time_slots") }}</span>
            </button>
        </div>
            ...
            <div class="db-card">
                ...
                <div class="db-card-body">
                    <div class="row py-2">
                        ...
                        <div v-if="branch.webhook_url" class="col-12 !py-1.5">
                            <div class="db-list-item p-0">
                                <span class="db-list-item-text mt-2 w-full">
                                    <span class="mt-2 db-list-item-title">{{ $t('label.webhook_url') }}</span><br>
                                    <span class="mt-2">{{ branch.webhook_url }}</span>
                                </span>
                            </div>
                        </div>
        ...
        <div id="deliverySetup" class="profile-tabDiv">
            <DeliverySetupListComponent />
        </div>
        <div id="timeSlot" class="profile-tabDiv">
...
import TimeSlotListComponent from "./timeSlot/TimeSlotListComponent.vue";
import DeliverySetupListComponent from "./deliverySetup/DeliverySetupListComponent.vue";
...
export default {
    ...
    components: {
        LoadingComponent, TimeSlotListComponent, DeliverySetupListComponent
    },
    data() {
        return {
            loading: {
