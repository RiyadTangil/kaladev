                ...
                <form @submit.prevent="save">
                    <div class="form-row">
                        ...
                        <div class="form-col-12 sm:form-col-12">
                            <label for="webhook_url" class="db-field-title">{{
                                $t("label.webhook_url")
                            }}</label>
                            <input v-model="props.form.webhook_url" v-bind:class="errors.webhook_url ? 'invalid' : ''" type="text"
                                id="webhook_url" class="db-field-control" />
                            <small class="db-field-alert" v-if="errors.webhook_url">{{
