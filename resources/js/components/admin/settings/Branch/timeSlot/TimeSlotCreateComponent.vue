<template>
    ...
    <button v-on:click="this.props.form.day = this.day" type="button" @click="add" data-modal="#timeSlotModal"
...
export default {
    ...
    methods: {
        add: function () {
            appService.modalShow("#timeSlotModal");
        },
        ...
        save: function () {
            try {
                ...
                this.$props.props.branch_id = this.$route.params.id;
                this.$store
