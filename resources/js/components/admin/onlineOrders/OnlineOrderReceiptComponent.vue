                ...
                <div class="py-2 pl-7">
                    <table class="w-full">
                        <tbody>
                            ...
                            <tr v-if="order.rider_tip > 0">
                                <td class="text-xs text-left py-0.5 uppercase text-heading">{{ $t('label.rider_tips')
                                    }}:
                                </td>
                                <td class="text-xs text-right py-0.5 text-heading">{{ order.rider_tip_currency_price }}
                                </td>
                            </tr>
