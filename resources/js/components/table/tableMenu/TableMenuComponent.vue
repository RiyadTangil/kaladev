        ...
        <div class="modal-dialog max-w-[360px] relative">
            ...
            <div class="modal-body">
                ...
                <div class="flex gap-6"
                    ...
                    <a :href="'/payment/table/' + order.id + '/pay'"
...
export default {
    ...
    computed: {
        ...
        items: function () {
            return this.$store.getters["tableItem/lists"];
        },
        setting: function () {
    ...
    methods: {
        ...
        itemList: function () {
                this.itemProps.search.table_slug = this.getTableSlug();
            this.loading.isActive = true;
            this.$store.dispatch("tableItem/lists", this.itemProps.search).then((res) => {
                this.loading.isActive = false;
            }).catch((err) => {
                this.loading.isActive = false;
            });
