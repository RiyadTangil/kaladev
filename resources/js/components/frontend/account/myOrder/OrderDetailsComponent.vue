                    ...
                    <div class="p-4">
                        <div class="rounded-xl border border-[#EFF0F6]">
                            <ul class="flex flex-col gap-2 p-3 border-b border-dashed border-[#EFF0F6]">
                                ...
                                <li class="flex items-center justify-between text-heading" v-if="order.rider_tip > 0">
                                    <span class="text-sm leading-6 capitalize">{{ $t("label.rider_tips") }}</span>
                                    <span class="text-sm leading-6 capitalize">
...
import FrontendOrderReceiptComponent from "./FrontendOrderReceiptComponent.vue";
