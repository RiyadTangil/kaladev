...
<body>
    ...
    <div class="py-14 px-4 w-full max-w-2xl mx-auto flex flex-col items-center justify-center">
        <a href="{{ route('home', 'cart=reset') }}" class="w-36 mb-8">
            <img class="w-full" src="{{ $logo->frontend_logo }}" alt="logo">
        </a>
        ...
        <h3 class="text-[22px] font-medium leading-[34px] text-center text-[#1AB759] mb-12">
            ...
            @else
            {{ __('all.message.order_successful') }}
            @endif
        </h3>
        <div class="w-full max-w-[360px]">
            ...
            @endif
            <a id="home-route" href="{{ url('my-orders/'.$order->id.'?cart=reset') }}"
